...
from modules.models import DenseNetModelLargeShare_3  # Need to specify proper model
...
model_path = PROJECT + '/checkpoints/' + TRIAL + '/checkpoint_000251/checkpoint-251'
...
def main():
    ...
    ModelCatalog.register_custom_model('my_model', DenseNetModelLargeShare_3)
